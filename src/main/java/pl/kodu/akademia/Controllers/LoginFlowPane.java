...
public class LoginFlowPane {
    ...
    @FXML
    public void autenthicate() throws IOException {
        ...
        if (passwordFromRepository.equals(hashPassword)) {
            String path = "/Users/dawidpaciorek/IdeaProjects/loginSystem/src/main/resources/greetingsPane.fxml";
